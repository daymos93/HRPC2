...
//mixure RPC
  ...
  G4double fAbsorDensity = fAbsorMaterial->GetDensity();
  fAbsorMass = fAbsorDensity*fAbsorSizeX*fAbsorSizeYZ*fAbsorSizeYZ;
...
G4double DetectorConstruction::GetAbsorMass() const {return fAbsorMass;}
